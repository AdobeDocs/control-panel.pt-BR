...
* [Configuração de subdomínios usando CNAMEs (vídeo tutorial)](https://docs.adobe.com/content/help/en/campaign-classic-learn/control-panel/subdomains-and-certificates/delegating-subdomains-using-cname.html)
